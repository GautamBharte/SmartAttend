...
import { WhatsAppConfigSection } from './WhatsAppConfigModal';
      ...
      <Tabs defaultValue="employees" className="w-full">
        <div className="overflow-x-auto -mx-3 sm:mx-0">
          <TabsList className="inline-flex min-w-full sm:min-w-0 w-full sm:w-auto">
            ...
            <TabsTrigger value="whatsapp" className="text-xs sm:text-sm whitespace-nowrap">
              <svg viewBox="0 0 24 24" className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-1.5 text-green-500 fill-current" xmlns="http://www.w3.org/2000/svg">
