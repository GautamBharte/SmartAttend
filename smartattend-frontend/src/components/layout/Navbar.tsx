...
import { Building2, LogOut, Menu, Moon, Sun, Edit } from 'lucide-react';
...
export const Navbar = ({ user, onLogout, onMenuToggle, showMenuButton = false, onProfileUpdate }: NavbarProps) => {
